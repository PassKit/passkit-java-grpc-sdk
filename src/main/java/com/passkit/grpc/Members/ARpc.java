...
public final class ARpc {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "s/member/events/id/{id}\022\340\001\n\023getProgramEn" +
      "rolment\022\006.io.Id\032\021.io.EnrolmentUrls\"\255\001\222A\202" +
      "\001\n\016Enrolment Urls\022\036Get Program Enrolment" +
      " Page URL\032PRetrieves enrolment page URL " +
      "of the base tier and enrolment URLs for " +
      "each tier .\202\323\344\223\002!\022\037/members/enrol/url/pr" +
      "ogram/{id}B\256\007\n\030com.passkit.grpc.MembersZ" +
      ",stash.passkit.com/io/model/sdk/go/io/me" +
      "mbers\252\002\024PassKit.Grpc.Members\222A\313\006\022\206\002\n\023Pas" +
      "sKit Members API\022lThe PassKit Members AP" +
      "I lets you manage your membership progra" +
      "ms and passes for Apple Wallet and Googl" +
      "e Pay.\0328https://passkit.com/legal/terms-" +
      "of-subscription-service/\"?\n\017PassKit Supp" +
      "ort\022\027https://docs.passkit.io\032\023support@pa" +
      "sskit.com2\0061.0-rc*\001\0022\020application/json:\020" +
      "application/jsonR9\n\003200\0222\n(Returned when" +
      " the request is successful.\022\006\n\004\232\002\001\007R4\n\0034" +
      "00\022-\n+Returned when wrong user input is " +
      "provided.R0\n\003401\022)\n\'Returned when the us" +
      "er is unauthorized.RP\n\003403\022I\nGReturned w" +
      "hen the user does not have permission to" +
      " access the resource.R;\n\003404\0224\n*Returned" +
      " when the resource does not exist.\022\006\n\004\232\002" +
      "\001\007R<\n\003500\0225\n+Returned when there is an u" +
      "nexpected error.\022\006\n\004\232\002\001\007RW\n\003503\022P\nNServe" +
      "r is unavailable. Back off for 250ms and" +
      " repeat request until successful.Z>\n<\n\na" +
      "piKeyAuth\022.\010\002\022\031JWT Authentication token." +
      "\032\rAuthorization \002b\020\n\016\n\napiKeyAuth\022\000b\006pro" +
      "to3"
    };
