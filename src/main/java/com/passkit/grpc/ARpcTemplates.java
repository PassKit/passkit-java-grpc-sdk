...
public final class ARpcTemplates {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "-pass-templates-locations-beacons-links-" +
      "filtering-listing-and-counting-by-api#fi" +
      "lter-links</a>\202\323\344\223\002\021\"\014/links/count:\001*B\361\006" +
      "\n\020com.passkit.grpcZ$stash.passkit.com/io" +
      "/model/sdk/go/io\252\002\014PassKit.Grpc\222A\246\006\022\341\001\n\025" +
      "PassKit Templates API\022dAPI for managing " +
      "Pass Templates & Designs for Apple Walle" +
      "t, Google Wallet and Data Collection For" +
      "ms.\032 https://passkit.com/legal/terms/\"@\n" +
      "\017PassKit Support\022\030https://help.passkit.c" +
      "om\032\023support@passkit.com*\001\0022\020application/" +
      "json:\020application/jsonR9\n\003200\0222\n(Returne" +
      "d when the request is successful.\022\006\n\004\232\002\001" +
      "\007R4\n\003400\022-\n+Returned when wrong user inp" +
      "ut is provided.R0\n\003401\022)\n\'Returned when " +
      "the user is unauthorized.RP\n\003403\022I\nGRetu" +
      "rned when the user does not have permiss" +
      "ion to access the resource.R;\n\003404\0224\n*Re" +
      "turned when the resource does not exist." +
      "\022\006\n\004\232\002\001\007R<\n\003500\0225\n+Returned when there i" +
      "s an unexpected error.\022\006\n\004\232\002\001\007RW\n\003503\022P\n" +
      "NServer is unavailable. Back off for 250" +
      "ms and repeat request until successful.Z" +
      ">\n<\n\napiKeyAuth\022.\010\002\022\031JWT Authentication " +
