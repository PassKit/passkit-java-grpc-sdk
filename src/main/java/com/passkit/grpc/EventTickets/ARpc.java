...
public final class ARpc {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Tickets/tickets/count:\001*B\330\007\n\035com.passkit" +
      ".grpc.EventTicketsZ2stash.passkit.com/io" +
      "/model/sdk/go/io/event_tickets\252\002\031PassKit" +
      ".Grpc.EventTickets\222A\345\006\022\240\002\n\031PassKit Event" +
      " Tickets API\022\224\001This API enables you to g" +
      "et all your Digital Event Tickets into A" +
      "pple Wallet & Google Wallet, from theatr" +
      "e and cinema, to sport events and concer" +
      "ts.\032 https://passkit.com/legal/terms/\"@\n" +
      "\017PassKit Support\022\030https://help.passkit.c" +
      "om\032\023support@passkit.com2\0100.1-spec*\001\0022\020ap" +
      "plication/json:\020application/jsonR9\n\003200\022" +
      "2\n(Returned when the request is successf" +
      "ul.\022\006\n\004\232\002\001\007R4\n\003400\022-\n+Returned when wron" +
      "g user input is provided.R0\n\003401\022)\n\'Retu" +
      "rned when the user is unauthorized.RP\n\0034" +
      ...
      "RW\n\003503\022P\nNServer is unavailable. Back o" +
      "ff for 250ms and repeat request until su" +
      "ccessful.Z>\n<\n\napiKeyAuth\022.\010\002\022\031JWT Authe" +
      "ntication token.\032\rAuthorization \002b\020\n\016\n\na" +
      "piKeyAuth\022\000b\006proto3"
    };
