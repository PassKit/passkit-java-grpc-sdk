...
java.lang.String defaultValue) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(signingSecret_)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 4, signingSecret_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(signingSecret_)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(4, signingSecret_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
