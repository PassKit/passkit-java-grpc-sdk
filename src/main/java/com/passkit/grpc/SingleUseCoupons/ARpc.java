...
public final class ARpc {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "SingleUseCoupons\222A\357\006\022\252\002\n\035PassKit Single " +
      "Use Coupon API\022\237\001This protocol is suit f" +
      "or cases where the user requires a clean" +
      " and simple single use coupon for short " +
      "term coupon campaigns in Apple Wallet an" +
      "d Google Wallet.\032 https://passkit.com/le" +
      "gal/terms/\"@\n\017PassKit Support\022\030https://h" +
      "elp.passkit.com\032\023support@passkit.com2\0031." +
