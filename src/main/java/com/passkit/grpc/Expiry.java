  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 0,
        /* suffix= */ "",
        ExpirySettings.class.getName());
    }
    // Use ExpirySettings.newBuilder() to construct.
    private ExpirySettings(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                input.readMessage(
                    internalGetFixedExpiryDateFieldBuilder().getBuilder(),
                    extensionRegistry);
                expiryOneofCase_ = 2;
                break;
              } // case 18
      ...
      public com.passkit.grpc.CommonObjects.Date.Builder getFixedExpiryDateBuilder() {
        return internalGetFixedExpiryDateFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * The expiry date for digital membership card.
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          internalGetFixedExpiryDateFieldBuilder() {
        if (fixedExpiryDateBuilder_ == null) {
          if (!(expiryOneofCase_ == 2)) {
            expiryOneof_ = com.passkit.grpc.CommonObjects.Date.getDefaultInstance();
          }
          fixedExpiryDateBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              com.passkit.grpc.CommonObjects.Date, com.passkit.grpc.CommonObjects.Date.Builder, com.passkit.grpc.CommonObjects.DateOrBuilder>(
