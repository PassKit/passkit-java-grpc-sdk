...
public final class Reporting {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 0,
        /* suffix= */ "",
        AnalyticsResponse.class.getName());
    }
    // Use AnalyticsResponse.newBuilder() to construct.
    private AnalyticsResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
          ...
          internalGetDeviceBreakdownFieldBuilder();
      ...
      public Builder clear() {
        ...
        if (deviceBreakdownBuilder_ != null) {
          deviceBreakdownBuilder_.dispose();
      ...
      private void buildPartialRepeatedFields(com.passkit.grpc.Reporting.AnalyticsResponse result) {
        if (dataBuilder_ == null) {
      ...
      private void buildPartial0(com.passkit.grpc.Reporting.AnalyticsResponse result) {
        ...
        if (((from_bitField0_ & 0x00000020) != 0)) {
          result.deviceBreakdown_ = deviceBreakdownBuilder_ == null
              ? deviceBreakdown_
              : deviceBreakdownBuilder_.build();
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 50: {
                input.readMessage(
                    internalGetDeviceBreakdownFieldBuilder().getBuilder(),
                    extensionRegistry);
      ...
      public Builder mergeDeviceBreakdown(com.passkit.grpc.Reporting.DeviceBreakdown value) {
        if (deviceBreakdownBuilder_ == null) {
          if (((bitField0_ & 0x00000020) != 0) &&
            deviceBreakdown_ != null &&
            deviceBreakdown_ != com.passkit.grpc.Reporting.DeviceBreakdown.getDefaultInstance()) {
            getDeviceBreakdownBuilder().mergeFrom(value);
          } else {
            deviceBreakdown_ = value;
          }
        } else {
      ...
      public com.passkit.grpc.Reporting.DeviceBreakdown.Builder getDeviceBreakdownBuilder() {
        bitField0_ |= 0x00000020;
        onChanged();
        return internalGetDeviceBreakdownFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * Total number of passes installed for each device type.
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          internalGetDeviceBreakdownFieldBuilder() {
        if (deviceBreakdownBuilder_ == null) {
          deviceBreakdownBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              com.passkit.grpc.Reporting.DeviceBreakdown, com.passkit.grpc.Reporting.DeviceBreakdown.Builder, com.passkit.grpc.Reporting.DeviceBreakdownOrBuilder>(
                  getDeviceBreakdown(),
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 0,
        /* suffix= */ "",
        DeviceBreakdown.class.getName());
    }
    // Use DeviceBreakdown.newBuilder() to construct.
    private DeviceBreakdown(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.passkit.grpc.Reporting.DeviceBreakdown result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 0,
        /* suffix= */ "",
        ChartDataPoints.class.getName());
    }
    // Use ChartDataPoints.newBuilder() to construct.
    private ChartDataPoints(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.passkit.grpc.Reporting.ChartDataPoints result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.name_ = name_;
        }
  ...
  public interface AnalyticsRequestOrBuilder extends
    ...
    com.passkit.grpc.Reporting.AnalyticsRequest.FilterCase getFilterCase();
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 0,
        /* suffix= */ "",
        AnalyticsRequest.class.getName());
    }
    // Use AnalyticsRequest.newBuilder() to construct.
    private AnalyticsRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.passkit.grpc.Reporting.AnalyticsRequest result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      private void buildPartialOneofs(com.passkit.grpc.Reporting.AnalyticsRequest result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 122: {
                input.readMessage(
                    internalGetCouponFieldBuilder().getBuilder(),
                    extensionRegistry);
                filterCase_ = 15;
                break;
              } // case 122
              case 130: {
                input.readMessage(
                    internalGetFlightFieldBuilder().getBuilder(),
                    extensionRegistry);
                filterCase_ = 16;
                break;
              } // case 130
              case 138: {
                input.readMessage(
                    internalGetEventTicketFieldBuilder().getBuilder(),
                    extensionRegistry);
                filterCase_ = 17;
                break;
              } // case 138
      ...
      public com.passkit.grpc.Reporting.FlightAnalyticsFilter.Builder getFlightBuilder() {
        return internalGetFlightFieldBuilder().getBuilder();
      }
      /**
       * <code>.io.FlightAnalyticsFilter flight = 16;</code>
       */
      ...
      public com.passkit.grpc.Reporting.EventTicketAnalyticsFilter.Builder getEventTicketBuilder() {
        return internalGetEventTicketFieldBuilder().getBuilder();
      }
      /**
       * <code>.io.EventTicketAnalyticsFilter eventTicket = 17;</code>
       */
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          internalGetEventTicketFieldBuilder() {
        if (eventTicketBuilder_ == null) {
          if (!(filterCase_ == 17)) {
            filter_ = com.passkit.grpc.Reporting.EventTicketAnalyticsFilter.getDefaultInstance();
          }
          eventTicketBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              com.passkit.grpc.Reporting.EventTicketAnalyticsFilter, com.passkit.grpc.Reporting.EventTicketAnalyticsFilter.Builder, com.passkit.grpc.Reporting.EventTicketAnalyticsFilterOrBuilder>(
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 0,
        /* suffix= */ "",
        CouponAnalyticsFilter.class.getName());
    }
    // Use CouponAnalyticsFilter.newBuilder() to construct.
    private CouponAnalyticsFilter(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.passkit.grpc.Reporting.CouponAnalyticsFilter result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 0,
        /* suffix= */ "",
        FlightAnalyticsFilter.class.getName());
    }
    // Use FlightAnalyticsFilter.newBuilder() to construct.
    private FlightAnalyticsFilter(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(flightNumber_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, flightNumber_);
      }
      if (((bitField0_ & 0x00000001) != 0)) {
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(flightNumber_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, flightNumber_);
      }
      if (((bitField0_ & 0x00000001) != 0)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.passkit.grpc.Reporting.FlightAnalyticsFilter result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 0,
        /* suffix= */ "",
        EventTicketAnalyticsFilter.class.getName());
    }
    // Use EventTicketAnalyticsFilter.newBuilder() to construct.
    private EventTicketAnalyticsFilter(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(ticketTypeId_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, ticketTypeId_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(ticketTypeUid_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, ticketTypeUid_);
      }
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(venueUid_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 4, venueUid_);
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(ticketTypeId_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, ticketTypeId_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(ticketTypeUid_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, ticketTypeUid_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(venueId_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(3, venueId_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(venueUid_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(4, venueUid_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(eventId_)) {
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.passkit.grpc.Reporting.EventTicketAnalyticsFilter result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
