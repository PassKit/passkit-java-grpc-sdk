...
public final class TransactionOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(transactionSource_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 14, transactionSource_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(transactionSource_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(14, transactionSource_);
      }
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
          ...
          internalGetOrderItemsFieldBuilder();
          internalGetDiscountItemsFieldBuilder();
      ...
      public Builder mergeFrom(com.passkit.grpc.TransactionOuterClass.Transaction other) {
        ...
        if (java.lang.Float.floatToRawIntBits(other.getTotalPrice()) != 0) {
            ...
            if (orderItemsBuilder_.isEmpty()) {
              ...
              orderItemsBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetOrderItemsFieldBuilder() : null;
            } else {
              orderItemsBuilder_.addAllMessages(other.orderItems_);
            }
          }
        }
        if (java.lang.Float.floatToRawIntBits(other.getDiscount()) != 0) {
          ...
          if (!other.discountItems_.isEmpty()) {
            if (discountItemsBuilder_.isEmpty()) {
              ...
              discountItemsBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetDiscountItemsFieldBuilder() : null;
            } else {
              discountItemsBuilder_.addAllMessages(other.discountItems_);
            }
          }
        }
        if (java.lang.Float.floatToRawIntBits(other.getServiceCharge()) != 0) {
          setServiceCharge(other.getServiceCharge());
        }
        if (java.lang.Float.floatToRawIntBits(other.getTotalTax()) != 0) {
          setTotalTax(other.getTotalTax());
        }
        if (java.lang.Float.floatToRawIntBits(other.getFinalPrice()) != 0) {
          setFinalPrice(other.getFinalPrice());
        }
        if (java.lang.Float.floatToRawIntBits(other.getRoundingDifference()) != 0) {
      ...
      public com.passkit.grpc.TransactionOuterClass.OrderItem.Builder getOrderItemsBuilder(
          int index) {
        return internalGetOrderItemsFieldBuilder().getBuilder(index);
      }
      /**
       * <pre>
       * List of order items in the  transaction
      ...
      public com.passkit.grpc.TransactionOuterClass.OrderItem.Builder addOrderItemsBuilder() {
        return internalGetOrderItemsFieldBuilder().addBuilder(
      ...
      public java.util.List<com.passkit.grpc.TransactionOuterClass.OrderItem.Builder> 
        ...
        return internalGetOrderItemsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
      ...
      public com.passkit.grpc.TransactionOuterClass.DiscountItem.Builder getDiscountItemsBuilder(
          int index) {
        return internalGetDiscountItemsFieldBuilder().getBuilder(index);
      }
      /**
       * <pre>
       * List of discount items
      ...
      public com.passkit.grpc.TransactionOuterClass.DiscountItem.Builder addDiscountItemsBuilder() {
        return internalGetDiscountItemsFieldBuilder().addBuilder(
      ...
      public java.util.List<com.passkit.grpc.TransactionOuterClass.DiscountItem.Builder> 
        ...
        return internalGetDiscountItemsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ...
          internalGetDiscountItemsFieldBuilder() {
        if (discountItemsBuilder_ == null) {
          discountItemsBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              com.passkit.grpc.TransactionOuterClass.DiscountItem, com.passkit.grpc.TransactionOuterClass.DiscountItem.Builder, com.passkit.grpc.TransactionOuterClass.DiscountItemOrBuilder>(
                  discountItems_,
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 0,
        /* suffix= */ "",
        DiscountItem.class.getName());
    }
    // Use DiscountItem.newBuilder() to construct.
    private DiscountItem(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(discountCode_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, discountCode_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(voucherCode_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, voucherCode_);
      }
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(itemName_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 5, itemName_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(discountCode_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, discountCode_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(voucherCode_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, voucherCode_);
      }
      if (java.lang.Float.floatToRawIntBits(amount_) != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(itemName_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(5, itemName_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
