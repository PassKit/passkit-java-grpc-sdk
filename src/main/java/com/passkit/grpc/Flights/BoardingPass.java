...
public final class BoardingPass {
  ...
  public interface BoardingPassRecordOrBuilder extends
     ...
     * </pre>
     *
     * <code>string PriorityStatus = 40;</code>
     * @return The priorityStatus.
     */
    java.lang.String getPriorityStatus();
    /**
     * <pre>
     * A string that indicates any priority status or privileges that a passenger may have for the flight. Examples could include "Priority Boarding", "Lounge Access", "Extra Cabin Baggage", etc.
     * </pre>
     *
     * <code>string PriorityStatus = 40;</code>
     * @return The bytes for priorityStatus.
     */
    com.google.protobuf.ByteString
        getPriorityStatusBytes();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SECURITYPROGRAMS_FIELD_NUMBER = 39;
    @SuppressWarnings("serial")
    ...
    public static final int PRIORITYSTATUS_FIELD_NUMBER = 40;
    @SuppressWarnings("serial")
    private volatile java.lang.Object priorityStatus_ = "";
    /**
     * <pre>
     * A string that indicates any priority status or privileges that a passenger may have for the flight. Examples could include "Priority Boarding", "Lounge Access", "Extra Cabin Baggage", etc.
     * </pre>
     ...
     */
    @java.lang.Override
    public java.lang.String getPriorityStatus() {
      java.lang.Object ref = priorityStatus_;
      if (ref instanceof java.lang.String) {
        return (java.lang.String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(priorityStatus_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 40, priorityStatus_);
      }
    ...
    public int getSerializedSize() {
      ...
      }
      {
        ...
        size += dataSize;
        if (!getCapabilitiesList().isEmpty()) {  size += 2;
          size += com.google.protobuf.CodedOutputStream
      ...
      }
      {
        ...
        size += dataSize;
        if (!getSecurityProgramsList().isEmpty()) {  size += 2;
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(dataSize);
        }securityProgramsMemoizedSerializedSize = dataSize;
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(priorityStatus_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(40, priorityStatus_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getPriorityStatus()
          .equals(other.getPriorityStatus())) return false;
      if (!getInfantPassId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + PRIORITYSTATUS_FIELD_NUMBER;
      hash = (53 * hash) + getPriorityStatus().hashCode();
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
          ...
          internalGetPassengerFieldBuilder();
          ...
          internalGetAdditionalDataItemsFieldBuilder();
      ...
      private void buildPartial1(com.passkit.grpc.Flights.BoardingPass.BoardingPassRecord result) {
        ...
        if (((from_bitField1_ & 0x00000010) != 0)) {
          result.priorityStatus_ = priorityStatus_;
        }
      ...
      public Builder mergeFrom(com.passkit.grpc.Flights.BoardingPass.BoardingPassRecord other) {
        ...
        if (!other.getPriorityStatus().isEmpty()) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 98: {
                input.readMessage(
                    internalGetPassengerFieldBuilder().getBuilder(),
                    extensionRegistry);
              ...
              case 282: {
                input.readMessage(
                    internalGetAdditionalDataItemsFieldBuilder().getBuilder(),
                    extensionRegistry);
              ...
              case 322: {
                priorityStatus_ = input.readStringRequireUtf8();
                bitField1_ |= 0x00000010;
                break;
              } // case 322
              default: {
      ...
      public com.passkit.grpc.Flights.PassengerOuterClass.Passenger.Builder getPassengerBuilder() {
        bitField0_ |= 0x00000400;
        onChanged();
        return internalGetPassengerFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * Details of the passenger and any infant.
      ...
      public com.passkit.grpc.CommonObjects.DataItems.Builder getAdditionalDataItemsBuilder() {
        bitField1_ |= 0x00000001;
        onChanged();
        return internalGetAdditionalDataItemsFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * Optional key value pairs to be added in to the flight record.
      ...
      private java.lang.Object priorityStatus_ = "";
      /**
       * <pre>
       * A string that indicates any priority status or privileges that a passenger may have for the flight. Examples could include "Priority Boarding", "Lounge Access", "Extra Cabin Baggage", etc.
       * </pre>
       ...
       *
       * <code>string PriorityStatus = 40;</code>
       * @param value The priorityStatus to set.
       * @return This builder for chaining.
       */
      public Builder setPriorityStatus(
          java.lang.String value) {
        if (value == null) { throw new NullPointerException(); }
        priorityStatus_ = value;
        bitField1_ |= 0x00000010;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearPriorityStatus() {
        priorityStatus_ = getDefaultInstance().getPriorityStatus();
       ...
       *
       * <code>string PriorityStatus = 40;</code>
       * @param value The bytes for priorityStatus to set.
       * @return This builder for chaining.
       */
      public Builder setPriorityStatusBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) { throw new NullPointerException(); }
        checkByteStringIsUtf8(value);
        priorityStatus_ = value;
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                input.readMessage(
                    internalGetTicketNumberFieldBuilder().getBuilder(),
                    extensionRegistry);
                requestCase_ = 1;
                break;
              } // case 10
              ...
              case 26: {
                input.readMessage(
                    internalGetPnrFieldBuilder().getBuilder(),
                    extensionRegistry);
                requestCase_ = 3;
                break;
              } // case 26
              case 34: {
                input.readMessage(
                    internalGetPassIdFieldBuilder().getBuilder(),
                    extensionRegistry);
                requestCase_ = 4;
                break;
              } // case 34
      ...
      public com.passkit.grpc.Flights.BoardingPass.BoardingPassRecordRequestByTicketNumber.Builder getTicketNumberBuilder() {
        return internalGetTicketNumberFieldBuilder().getBuilder();
      }
      /**
       * <code>.flights.BoardingPassRecordRequestByTicketNumber ticketNumber = 1;</code>
       */
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          internalGetTicketNumberFieldBuilder() {
        if (ticketNumberBuilder_ == null) {
          if (!(requestCase_ == 1)) {
            request_ = com.passkit.grpc.Flights.BoardingPass.BoardingPassRecordRequestByTicketNumber.getDefaultInstance();
          }
      ...
      public com.passkit.grpc.Flights.BoardingPass.BoardingPassesForBookingRequest.Builder getPnrBuilder() {
        return internalGetPnrFieldBuilder().getBuilder();
      }
      /**
       * <code>.flights.BoardingPassesForBookingRequest pnr = 3;</code>
       */
      ...
      public com.passkit.grpc.CommonObjects.Id.Builder getPassIdBuilder() {
        return internalGetPassIdFieldBuilder().getBuilder();
      }
      /**
       * <code>.io.Id passId = 4;</code>
       */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
          ...
          if (!other.boardingPasses_.isEmpty()) {
            if (boardingPassesBuilder_.isEmpty()) {
              ...
              boardingPassesBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetBoardingPassesFieldBuilder() : null;
            } else {
      ...
      public com.passkit.grpc.CommonObjects.PassBundle.Builder getBoardingPassesBuilder(
          int index) {
        return internalGetBoardingPassesFieldBuilder().getBuilder(index);
      }
      /**
       * <pre>
       * An array of boarding passes found relating to the PNR.
      ...
      public com.passkit.grpc.CommonObjects.PassBundle.Builder addBoardingPassesBuilder() {
        return internalGetBoardingPassesFieldBuilder().addBuilder(
      ...
      public java.util.List<com.passkit.grpc.CommonObjects.PassBundle.Builder> 
        ...
        return internalGetBoardingPassesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ...
          internalGetBoardingPassesFieldBuilder() {
        if (boardingPassesBuilder_ == null) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\035\n\025barcodeAdditionalData\030! \001(\t\022*\n\023addit" +
      "ionalDataItems\030# \001(\0132\r.io.DataItems\022!\n\004u" +
      "rls\030% \001(\0132\023.flights.FlightURLs\0224\n\014capabi" +
      "lities\030& \003(\0162\036.flights.PassengerCapabili" +
      "ties\022:\n\020securityPrograms\030\' \003(\0162 .flights" +
      ".AirportSecurityPrograms\022\026\n\016PriorityStat" +
      "us\030( \001(\t\022\024\n\014infantPassId\030\" \001(\t\022\036\n\010metada" +
      "ta\030$ \001(\0132\014.io.Metadata:\370\003\222A\364\003\n\361\003*\024Boardi" +
      "ng Pass Record2\327\002A Boarding Pass record " +
      "is unique to an individual passenger jou" +
      "rney form a boarding point to a deplanin" +
      "g point. A Carrier and a Flight Designat" +
      "or record must exist. If a Flight record" +
      " does not already exist, then it will be" +
      " auto-generated based on the Flight Desi" +
      "gnator record (and other publicly availa" +
      "ble data if subscribed to data updates)." +
      "\322\001\023operatingCarrierPNR\322\001\016sequenceNumber\322" +
      "\001\rboardingPoint\322\001\016deplaningPoint\322\001\014fligh" +
      "tNumber\322\001\rdepartureDate\322\001\tpassenger\322\001\013ca" +
      "rrierCode\"\271\002\n\'BoardingPassRecordRequestB" +
      "yTicketNumber\022*\n\014ticketNumber\030\001 \001(\tB\024\222A\021" +
      "\212\001\016^([0-9]{3,10}$\022\021\n\tticketLeg\030\002 \001(\005\022\025\n\r" +
      "boardingPoint\030\003 \001(\t:\267\001\222A\263\001\n\260\001*%Boarding " +
      "Pass Record By Ticket Number2xUsed to ac" +
      "cess a single boarding pass or boarding " +
      "pass record.  Either a ticket leg or boa" +
      "rding point should be provided\322\001\014ticketN" +
      "umber\"\371\002\n BoardingPassRecordRequestByInd" +
      "ex\022\035\n\013carrierCode\030\001 \001(\tB\010\222A\005x\003\200\001\002\022\033\n\014fli" +
      "ghtNumber\030\002 \001(\tB\005\222A\002x\005\022\037\n\rdepartureDate\030" +
      "\003 \001(\0132\010.io.Date\022)\n\rboardingPoint\030\004 \001(\tB\022" +
      "\222A\017\212\001\014^[A-Z]{3,4}$\022\026\n\016sequenceNumber\030\005 \001" +
      "(\005:\264\001\222A\260\001\n\255\001*\035Boarding Pass Record By In" +
      "dex2>Used to access a single boarding pa" +
      "ss or boarding pass record.\322\001\013carrierCod" +
      "e\322\001\014flightNumber\322\001\rdepartureDate\322\001\rboard" +
      "ingPoint\322\001\016sequenceNumber\"\237\002\n\023BoardingPa" +
      "ssRequest\022H\n\014ticketNumber\030\001 \001(\01320.flight" +
      "s.BoardingPassRecordRequestByTicketNumbe" +
      "rH\000\022:\n\005index\030\002 \001(\0132).flights.BoardingPas" +
      "sRecordRequestByIndexH\000\0227\n\003pnr\030\003 \001(\0132(.f" +
      "lights.BoardingPassesForBookingRequestH\000" +
      "\022\030\n\006passId\030\004 \001(\0132\006.io.IdH\000\022$\n\006format\030\005 \003" +
      "(\0162\024.io.PassBundleFormatB\t\n\007request\"\306\001\n\031" +
      "BoardingPassRecordRequest\022H\n\014ticketNumbe" +
      "r\030\001 \001(\01320.flights.BoardingPassRecordRequ" +
      "estByTicketNumberH\000\022:\n\005index\030\002 \001(\0132).fli" +
      "ghts.BoardingPassRecordRequestByIndexH\000\022" +
      "\030\n\006passId\030\003 \001(\0132\006.io.IdH\000B\t\n\007request\"\330\001\n" +
      "\037BoardingPassesForBookingRequest\022\013\n\003pnr\030" +
      "\001 \001(\t\022\021\n\tticketLeg\030\002 \001(\005\022\025\n\rboardingPoin" +
      "t\030\003 \001(\t:~\222A{\ny*\"Boarding Pass Record By " +
      "PNR record2MUsed to access a single or m" +
      "ultiple boarding passed or boarding pass" +
      " records.\322\001\003pnr\"@\n\026BoardingPassesRespons" +
      "e\022&\n\016boardingPasses\030\001 \003(\0132\016.io.PassBundl" +
      "eB_\n\030com.passkit.grpc.FlightsZ,stash.pas" +
      "skit.com/io/model/sdk/go/io/flights\252\002\024Pa" +
      "ssKit.Grpc.Flightsb\006proto3"
    };
